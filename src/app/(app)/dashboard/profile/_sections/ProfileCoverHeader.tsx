// app/(app)/dashboard/profile/sections/ProfileCoverHeader.tsx
'use client';
...
export type ProfileUser = {
  userName: string;
  fullName?: string;
  avatarUrl: string; // already resolved from cookie/api: fileId → full URL OR /assets/dummyUser.png
};
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-3 text-sm leading-relaxed text-white/90">
              Moto-vlogger. Exploring Indian routes with <span className="font-semibold">Sharthi</span>. Vegan, early riser, PPL lifter.
            </p>
          ...
          <div className="sm:self-start">
            <div className="bg-white/5 border border-border rounded-2xl px-4 py-3 min-w-[180px] flex items-baseline justify-between gap-3">
              ...
              <div className="flex items-baseline gap-1 font-mono [font-variant-numeric:tabular-nums]">
                <span className="text-2xl sm:text-3xl font-bold leading-none tracking-tight">8,450</span>
